...
export const metadata: Metadata = {
  title: "Политика конфиденциальности | Twizz_Project",
  description: "Политика обработки персональных данных и конфиденциальности Twizz_Project.",
}
        ...
        <div className="space-y-8 text-sm md:text-base leading-relaxed text-foreground">
          <section className="space-y-3">
            ...
            <p>
              ...
              пользователей сайта Twizz_Project (далее — Сайт) и составлена в соответствии с Федеральным законом
            ...
            <p>
              Оператор персональных данных: команда Twizz_Project (далее — Оператор).
            </p>
            <p>
