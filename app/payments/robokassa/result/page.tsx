      ...
      <div className="container mx-auto max-w-3xl px-4">
        <div className="group relative overflow-hidden rounded-[2rem] border border-border/70 bg-card/75 p-8 shadow-[0_20px_80px_rgba(15,23,42,0.18)] backdrop-blur-xl md:p-10">
          ...
          <div className="relative">
            <span className="inline-flex items-center rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1 text-xs uppercase tracking-[0.24em] text-cyan-700 dark:text-cyan-300">
              Robokassa / Result
            </span>
