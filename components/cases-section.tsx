...
const cases = [
  {
    title: "ScoutScope",
    description: "Scouting-платформа для поиска, оценки и ведения базы кандидатов в киберспорте",
    problem: "Скауты тратили дни на ручной просмотр матчей и сбор статистики по кандидатам",
    solution: "Структурированная воронка скаутинга с карточками игроков, сравнением и автообновлением базы",
  ...
  },
  {
    ...
    description: "Telegram-бот для быстрого поиска и мониторинга игроков СНГ через FaceIT",
    problem: "Отсутствие удобного инструмента для отслеживания статистики и активности игроков в регионе",
    solution: "Бот с интеграцией FaceIT API: поиск по нику, мониторинг рейтинга и уведомления об активности",
